        ...
        <div className="flex flex-col lg:flex-row justify-between items-center">
          <div className="w-[500px] md:ml-[34px]">
            ...
            <p className="text-[#60697b] text-xl">
              ...
              et inventore quam placeat ab expedita eum voluptate corrupti
              veritatis cumque quas totam quaerat.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="w-full md:w-[243px] h-[293px] bg-[#FEF3E4] p-10 flex flex-col justify-center rounded-lg md:ml-8 mt-6 md:mt-0">
              <span>                
                <svg
                  viewBox="0 0 507 512"
                  xmlns="http://www.w3.org/2000/svg"
                  className="svg-inject icon-svg icon-svg-md text-yellow mb-3 w-h-14 h-14"
                >
                  <path
              ...
              <h2 className="text-xl font-bold text[#343f52] py-2">24/7 Support</h2>
              <p>
                Nulla vitae elit libero, a pharetra augue. Donec id elit non mi
                porta.
              </p>
            </div>
            <div className="w-full md:w-[300px] h-[270px] bg-[#FAE6E7] p-10 flex flex-col justify-center rounded-lg md:mt-[22px] mt-6 md:0">
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 339.8 409.6"
                  class="svg-inject icon-svg icon-svg-md text-red mb-3 w-h-14 h-14"
                >
                  <path
                    class="lineal-stroke text-[#eea1a6]"
              ...
              <h2 className="text-xl font-bold text[#343f52] py-2">Secure Payments</h2>
              <p>
                Nulla vitae elit libero, a pharetra augue. Donec id elit non mi
                porta.
              </p>
            </div>
            <div className="w-full md:w-[243px] h-[236px] bg-[#EAF3EF] p-10 flex flex-col justify-center rounded-lg mt-6">
              <span>
                <svg
                  viewBox="0 0 512 427.5"
                  xmlns="http://www.w3.org/2000/svg"
                  class="svg-inject icon-svg icon-svg-md text-primary mb-3 w-h-14 h-14"
                >
                  <path
                    class="lineal-fill3"
              ...
              <h2 className="text-xl font-bold text[#343f52] py-2">Daily Updates</h2>
              <p>Nulla vitae elit libero, a pharetra augue.</p>
            </div>
            <div className="w-full md:w-[300px] h-[270px] bg-[#E0E9FA] p-10 flex flex-col justify-center rounded-lg mt-6 md:-ml-8">
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 409.6 361.2"
                  class="svg-inject icon-svg icon-svg-md text-leaf mb-3 w-h-14 h-14"
                >
                  <path
                    class="lineal-stroke"
              ...
              <h2 className="text-xl font-bold text[#343f52] py-2">Market Research</h2>
