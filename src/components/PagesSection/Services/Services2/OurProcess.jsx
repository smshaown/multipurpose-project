...
export const OurProcess = () => {
  return (
    <div className="bg-[#EDF2FC] mt-20 md:mt-40 mb-40">
      <div className="myContainer">        
        <div className="py-20">
        <div className=" w-full lg:w-[860px] flex flex-col mx-auto justify-center items-center">
          <span>
            {" "}
          ...
          <div className="flex flex-col md:flex-row justify-between gap-14 mt-10">
            <div className="flex flex-col justify-center text-center items-center">
              ...
              <h2 className="text-xl font-bold text-[#101724] py-2">
                1. Secured Transactions
              </h2>
              <p className="text-[60697b] font-sans mt-1">
            ...
            <div className="flex flex-col justify-center text-center items-center">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
                class="svg-inject icon-svg icon-svg-md text-green mb-3 w-h-14 h-14"
              >
                <path
                  class="lineal-stroke"
            ...
            <div className="flex flex-col justify-center text-center items-center">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
                class="svg-inject icon-svg icon-svg-md text-yellow mb-3 w-h-14 h-14"
              >
                <path
                  class="lineal-stroke"
